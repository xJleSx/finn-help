...
[![CI](https://github.com/xJleSx/finn-help/actions/workflows/ci.yml/badge.svg)](https://github.com/xJleSx/finn-help/actions/workflows/ci.yml)
...
SBER (Сбербанк):
  Цена: 286.50 ₽  (+1.2% за 5д)
  RSI(14): 58.2 — нейтральный
  MACD: сигнал к покупке
  BB(20): цена в канале
  ML: бычий сигнал (уверенность 0.72)
  Фундамент: P/E 5.8, ROE 22.3%
  Финальный сигнал: BUY (0.82)
```
