...
class TestResample:
    ...
    def test_resample_weekly(self):
        ...
        df = pd.DataFrame({"date": dates, "open": dates, "high": [d + 1 for d in dates], "low": [d - 1 for d in dates], "close": [d + 0.5 for d in dates], "volume": [100] * 30})
...
class TestConcordance:
    ...
    def test_all_agree(self):
        row = {"close": [100, 102], "rsi": [50, 60], "macd_hist": [0.0, 0.0], "sma_20": [100, 101], "sma_50": [100, 100]}
    ...
    def test_compute_all(self):
        df = pd.DataFrame({"date": list(range(100)), "open": [100] * 100, "high": [101] * 100, "low": [99] * 100, "close": [100 + i for i in range(100)], "volume": [1000] * 100})
